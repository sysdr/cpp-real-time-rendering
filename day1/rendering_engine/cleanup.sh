#!/bin/bash
# Stop all project and Docker services, remove unused Docker resources and project artifacts.
...
find "$SCRIPT_DIR" -maxdepth 3 -name "*.pyc" ! -path "*/.vcpkg-root/*" ! -path "*/deps/*" -delete 2>/dev/null || true
find "$SCRIPT_DIR" -maxdepth 3 -name "*.rr" ! -path "*/.vcpkg-root/*" ! -path "*/deps/*" -delete 2>/dev/null || true
