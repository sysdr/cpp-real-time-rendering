#!/usr/bin/env python3
"""Dashboard server: serves static files and provides /run-demo to run ./start.sh from the dashboard."""
import http.server
import json
import os
import subprocess
...
class DashboardHandler(http.server.BaseHTTPRequestHandler):
    ...
    def _run_demo(self):
        """Run ./start.sh in project directory and return JSON with stdout, stderr, returncode."""
        ...
        try:
            ...
            self._send_json({"stdout": "", "stderr": "Command timed out after 120s.", "returncode": -1})
